...
class DashboardView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if query:
            user_tasks = user_tasks.filter(title__icontains=query)
        ...
        context["pending_count"] = all_user_tasks.filter(done=False).count()

        context["completed_count"] = all_user_tasks.filter(done=True).count()
